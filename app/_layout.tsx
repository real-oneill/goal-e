...
function RootLayoutNav() {
  return (
    <Stack screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="log-bjj" options={{ presentation: "modal", animation: "slide_from_bottom" }} />
      <Stack.Screen name="log-guitar" options={{ presentation: "modal", animation: "slide_from_bottom" }} />
